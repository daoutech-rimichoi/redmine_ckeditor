...
CKEDITOR.plugins.setLang( 'a11yhelp', 'ko', {
	...
	legend: [
		...
		items: [
			{
			name: '편집기 툴바',
			legend: '툴바를 탐색하시려면 ${toolbarFocus} 를 누르세요. 이전/다음 툴바 그룹으로 이동하시려면 TAB 키 또는 SHIFT+TAB 키를 누르세요. 이전/다음 툴바 버튼으로 이동하시려면 오른쪽 화살표 키 또는 왼쪽 화살표 키를 누르세요. 툴바 버튼을 활성화 하려면 SPACE 키 또는 ENTER 키를 누르세요.'
		},
		...
		items: [
			...
			{
			name: ' 일반 텍스트로 붙여넣기',
			legend: '${pastetext} 누르시오',
			legendEdge: '${pastetext} 누른 후 ${paste} 누르시오'
		}
		]
	}
	],
